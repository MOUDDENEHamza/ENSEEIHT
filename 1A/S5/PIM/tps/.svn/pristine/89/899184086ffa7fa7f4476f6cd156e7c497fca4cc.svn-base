generic
	...
	with function "<" (Cle1, Cle2 : in T_Cle) return Boolean;
...
package ABR is
	...
	procedure Inserer (Abr : in out T_ABR ; Cle : in T_Cle ; Donnee : in T_Donnee) with
	...
	procedure Modifier (Abr : in out T_ABR ; Cle : in T_Cle ; Donnee : in T_Donnee) with
	...
	-- Exception : Cle_Absente_Exception si Clé n'est pas utilisée dans l'Abr
	function La_Donnee (Abr : in T_ABR ; Cle : in T_Cle) return T_Donnee;
