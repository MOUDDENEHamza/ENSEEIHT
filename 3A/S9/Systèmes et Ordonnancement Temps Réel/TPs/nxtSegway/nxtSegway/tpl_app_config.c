...
/* Resource cmd */
#define cmd_id 0
CONST(ResourceType, AUTOMATIC) cmd = cmd_id;
...
/* Task obstacle identifier */
#define obstacle_id 1
CONST(TaskType, AUTOMATIC) obstacle = obstacle_id;
...
/* Alarm alarm_obstacle identifier */
#define alarm_obstacle_id 1
CONST(AlarmType, AUTOMATIC) alarm_obstacle = alarm_obstacle_id;

/* Alarm alarm_pendule identifier */
#define alarm_pendule_id 2
...
#include "tpl_memmap.h"
/*-----------------------------------------------------------------------------
 * Resource descriptor of resource cmd
 *
 * Tasks which use this resource :
 * obstacle
 * pendule
 */
VAR(tpl_resource, OS_VAR) cmd_rez_desc = {
...
/*-----------------------------------------------------------------------------
 * Task obstacle descriptor
 */
#define APP_Task_obstacle_START_SEC_CODE
#include "tpl_memmap.h"
/*
 * Task obstacle function prototype
 */
FUNC(void, OS_APPL_CODE) obstacle_function(void);
#define APP_Task_obstacle_STOP_SEC_CODE
#include "tpl_memmap.h"
 ...
 * Task obstacle stack
 */
#define APP_Task_obstacle_START_SEC_STACK
#include "tpl_memmap.h"
VAR(tpl_stack_word, OS_APPL_DATA) obstacle_stack_zone[512/sizeof(tpl_stack_word)];
#define APP_Task_obstacle_STOP_SEC_STACK
#include "tpl_memmap.h"

#define obstacle_STACK {obstacle_stack_zone, 512}

/*
 * Task obstacle context
 */
#define OS_START_SEC_VAR_NOINIT_32BIT
#include "tpl_memmap.h"
VAR(arm_context, OS_VAR) obstacle_int_context;

#define obstacle_CONTEXT &obstacle_int_context
...
/*
 * Resources used by task obstacle
 *
 * cmd
 */

/*
 * Static descriptor of task obstacle
 */
CONST(tpl_proc_static, OS_CONST) obstacle_task_stat_desc = {
  /* context                  */  obstacle_CONTEXT,
  /* stack                    */  obstacle_STACK,
  /* entry point (function)   */  obstacle_function,
  /* internal ressource       */  NULL,
  /* task id                  */  obstacle_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task obstacle
 */
VAR(tpl_proc, OS_VAR) obstacle_task_desc = {
  /* resources                      */  NULL,
#if WITH_MEMORY_PROTECTION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_MEMORY_PROTECTION */
...
/*
 * Resources used by task pendule
 *
 * cmd
 */
...
/*-----------------------------------------------------------------------------
 * Alarm alarm_obstacle descriptor
 *
 * This alarm does the activation of task obstacle
 */
...
CONST(tpl_task_activation_action, OS_CONST) alarm_obstacle_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  obstacle_id
...
CONST(tpl_alarm_static, OS_CONST) alarm_obstacle_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_TRACE == YES)
    /* id of the alarm for tracing  */  , alarm_obstacle_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&alarm_obstacle_action
};
...
VAR(tpl_time_obj, OS_VAR) alarm_obstacle_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&alarm_obstacle_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  40,
    /* date                         */  1,
