...
public class ArrayAssignment extends AbstractArray implements AssignableExpression {
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		VariableDeclaration array_assignement = ((VariableAssignment) this.array).declaration;
		fragment.add(_factory.createLoad(array_assignement.getRegister(), array_assignement.getOffset(), this.getType().length()));
