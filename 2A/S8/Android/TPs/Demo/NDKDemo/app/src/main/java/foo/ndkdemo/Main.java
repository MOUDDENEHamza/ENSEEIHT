...
public class Main extends Activity
{
	...
	public void onCreate( Bundle savedInstanceState )
	{
		...
		OnClickListener handler = new OnClickListener()
		{
			...
			{
				final Lang lang = jb == v ? Lang.Java : Lang.C;
				...
				for( int i = 0; i < numReps; i++ )
				{
					...
					{
						case C:
							total += SqrtDemo.sqrtC( 123456789.0, SqrtDemo.EPSILON );
							break;
						case Java:
				...
				log.append( String.format(
						"Time %d iters in %s was %d msec, avg result %f%n",
						numReps, lang, time, total / numReps ) );
			}
		};
