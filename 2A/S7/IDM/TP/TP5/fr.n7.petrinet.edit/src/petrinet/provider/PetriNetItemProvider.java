...
public class PetriNetItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PetrinetPackage.Literals.PETRI_NET__PETRINETELEMENT);
			childrenFeatures.add(PetrinetPackage.Literals.PETRI_NET__EDGE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.PETRI_NET__PETRINETELEMENT,
		...
		newChildDescriptors.add
			(createChildParameter
				(PetrinetPackage.Literals.PETRI_NET__EDGE,
				 PetrinetFactory.eINSTANCE.createEdge()));
	}
