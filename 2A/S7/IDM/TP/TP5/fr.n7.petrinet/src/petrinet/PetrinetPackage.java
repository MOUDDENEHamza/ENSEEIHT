...
public interface PetrinetPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the containment reference list '{@link petrinet.PetriNet#getEdge <em>Edge</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Edge</em>'.
	 * @see petrinet.PetriNet#getEdge()
	 * @see #getPetriNet()
	 * @generated
	 */
	EReference getPetriNet_Edge();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference PETRI_NET__EDGE = eINSTANCE.getPetriNet_Edge();
