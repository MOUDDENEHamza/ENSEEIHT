...
public class EdgeImpl extends MinimalEObjectImpl.Container implements Edge {
	...
	public void setCible(Node newCible) {
		...
		cible = newCible;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.EDGE__CIBLE, oldCible, cible));
	}
	...
	public void setSource(Node newSource) {
		...
		source = newSource;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetrinetPackage.EDGE__SOURCE, oldSource, source));
	}
