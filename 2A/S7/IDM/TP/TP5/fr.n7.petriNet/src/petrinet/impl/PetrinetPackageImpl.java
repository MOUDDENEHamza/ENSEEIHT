...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 * @generated
	 */
	public EReference getPetriNet_Edge() {
	...
	public void createPackageContents() {
		...
		createEReference(petriNetEClass, PETRI_NET__EDGE);
	...
	public void initializePackageContents() {
		...
		initEReference(getPetriNet_Petrinetelement(), this.getNode(), null, "petrinetelement", null, 0, -1, PetriNet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPetriNet_Edge(), this.getEdge(), null, "edge", null, 0, -1, PetriNet.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(edgeEClass, Edge.class, "Edge", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getEdge_Cible(), this.getNode(), null, "cible", null, 0, 1, Edge.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
