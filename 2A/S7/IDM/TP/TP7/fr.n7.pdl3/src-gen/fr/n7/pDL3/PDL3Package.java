...
public interface PDL3Package extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link fr.n7.pDL3.impl.ProcessElementImpl <em>Process Element</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see fr.n7.pDL3.impl.ProcessElementImpl
   * @see fr.n7.pDL3.impl.PDL3PackageImpl#getProcessElement()
   * @generated
   */
  int PROCESS_ELEMENT = 1;

  /**
   * The feature id for the '<em><b>Work Definition</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int PROCESS_ELEMENT__WORK_DEFINITION = 0;

  /**
   * The feature id for the '<em><b>Work Sequence</b></em>' containment reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int PROCESS_ELEMENT__WORK_SEQUENCE = 1;
  ...
  /**
   * Returns the meta object for class '{@link fr.n7.pDL3.ProcessElement <em>Process Element</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL3.ProcessElement#getWorkDefinition <em>Work Definition</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Work Definition</em>'.
   * @see fr.n7.pDL3.ProcessElement#getWorkDefinition()
   * @see #getProcessElement()
   * @generated
   */
  EReference getProcessElement_WorkDefinition();

  /**
   * Returns the meta object for the containment reference list '{@link fr.n7.pDL3.ProcessElement#getWorkSequence <em>Work Sequence</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Work Sequence</em>'.
   * @see fr.n7.pDL3.ProcessElement#getWorkSequence()
   * @see #getProcessElement()
   * @generated
   */
  EReference getProcessElement_WorkSequence();
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link fr.n7.pDL3.impl.ProcessElementImpl <em>Process Element</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see fr.n7.pDL3.impl.ProcessElementImpl
     * @see fr.n7.pDL3.impl.PDL3PackageImpl#getProcessElement()
    ...
    /**
     * The meta object literal for the '<em><b>Work Definition</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference PROCESS_ELEMENT__WORK_DEFINITION = eINSTANCE.getProcessElement_WorkDefinition();

    /**
     * The meta object literal for the '<em><b>Work Sequence</b></em>' containment reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference PROCESS_ELEMENT__WORK_SEQUENCE = eINSTANCE.getProcessElement_WorkSequence();
