...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.ProcessElementsImpl <em>Process Elements</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.ProcessElementsImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getProcessElements()
	 * @generated
	 */
	int PROCESS_ELEMENTS = 3;
	 ...
	 * @ordered
	 */
	int PROCESS_ELEMENTS_OPERATION_COUNT = 0;
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION__LINKS_TO_PREDECESSORS = PROCESS_ELEMENTS_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION__LINKS_TO_SUCCESSORS = PROCESS_ELEMENTS_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION__NAME = PROCESS_ELEMENTS_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION__ALLOCATE = PROCESS_ELEMENTS_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION_FEATURE_COUNT = PROCESS_ELEMENTS_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int WORK_DEFINITION_OPERATION_COUNT = PROCESS_ELEMENTS_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int WORK_SEQUENCE__PREDECESSOR = PROCESS_ELEMENTS_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int WORK_SEQUENCE__SUCCESSOR = PROCESS_ELEMENTS_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int WORK_SEQUENCE__LINK_TYPE = PROCESS_ELEMENTS_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int WORK_SEQUENCE_FEATURE_COUNT = PROCESS_ELEMENTS_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int WORK_SEQUENCE_OPERATION_COUNT = PROCESS_ELEMENTS_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int GUIDANCE__TEXT = PROCESS_ELEMENTS_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int GUIDANCE__ELEMENTS = PROCESS_ELEMENTS_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int GUIDANCE_FEATURE_COUNT = PROCESS_ELEMENTS_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int GUIDANCE_OPERATION_COUNT = PROCESS_ELEMENTS_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESSOURCE__NAME = PROCESS_ELEMENTS_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int RESSOURCE__QUANTITE = PROCESS_ELEMENTS_FEATURE_COUNT + 1;

	/**
	 * The feature id for the '<em><b>Allocate</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int RESSOURCE__ALLOCATE = PROCESS_ELEMENTS_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int RESSOURCE_FEATURE_COUNT = PROCESS_ELEMENTS_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int RESSOURCE_OPERATION_COUNT = PROCESS_ELEMENTS_OPERATION_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ALLOCATE__WORKDEFINITION = 2;
	...
	/**
	 * Returns the meta object for class '{@link simplepdl.ProcessElements <em>Process Elements</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference list '{@link simplepdl.Ressource#getAllocate <em>Allocate</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Allocate</em>'.
	 * @see simplepdl.Ressource#getAllocate()
	 * @see #getRessource()
	 * @generated
	 */
	EReference getRessource_Allocate();
	...
	/**
	 * Returns the meta object for the reference '{@link simplepdl.Allocate#getWorkdefinition <em>Workdefinition</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Workdefinition</em>'.
	 * @see simplepdl.Allocate#getWorkdefinition()
	 * @see #getAllocate()
	 * @generated
	 */
	EReference getAllocate_Workdefinition();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link simplepdl.impl.ProcessElementsImpl <em>Process Elements</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.ProcessElementsImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getProcessElements()
		...
		/**
		 * The meta object literal for the '<em><b>Allocate</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference RESSOURCE__ALLOCATE = eINSTANCE.getRessource_Allocate();
		 ...
		 * @generated
		 */
		EReference ALLOCATE__WORKDEFINITION = eINSTANCE.getAllocate_Workdefinition();
