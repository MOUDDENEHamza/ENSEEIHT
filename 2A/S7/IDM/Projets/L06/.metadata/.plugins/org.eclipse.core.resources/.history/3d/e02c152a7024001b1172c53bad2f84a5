 ...
 * @generated
 */
public class GuidanceImpl extends ProcessElementsImpl implements Guidance {
	/**
	...
	public EList<ProcessElements> getElements() {
		if (elements == null) {
			elements = new EObjectResolvingEList<ProcessElements>(ProcessElements.class, this, SimplepdlPackage.GUIDANCE__ELEMENTS);
		}
		return elements;
	}
