...
/**
 * This is the item provider adapter for a {@link petrinet.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider extends PetriNetElementItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_cible_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_cible_feature", "_UI_Edge_type"),
				 PetrinetPackage.Literals.EDGE__CIBLE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetrinetPackage.Literals.EDGE__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTokensPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_tokens_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_tokens_feature", "_UI_Edge_type"),
				 PetrinetPackage.Literals.EDGE__TOKENS,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PetrinetPackage.Literals.EDGE__TYPE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Edge_type") + " " + edge.getTokens();
	}
