...
public class ProcessImpl extends MinimalEObjectImpl.Container implements simplepdl.Process {
	 ...
	 * @ordered
	 */
	protected EList<ProcessElements> processElements;
	 ...
	 * @generated
	 */
	public EList<ProcessElements> getProcessElements() {
		if (processElements == null) {
			processElements = new EObjectContainmentEList<ProcessElements>(ProcessElements.class, this, SimplepdlPackage.PROCESS__PROCESS_ELEMENTS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.PROCESS__PROCESS_ELEMENTS:
				...
				getProcessElements().addAll((Collection<? extends ProcessElements>)newValue);
				return;
		}
