 ...
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementsImpl implements WorkDefinition {
	/**
	 ...
	 * @generated
	 */
	public EList getAllocate() {
		if (allocate == null) {
			allocate = new EObjectContainmentEList(Allocate.class, this, SimplepdlPackage.WORK_DEFINITION__ALLOCATE);
		}
		return allocate;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SimplepdlPackage.WORK_DEFINITION__LINKS_TO_PREDECESSORS:
				return ((InternalEList)getLinksToPredecessors()).basicAdd(otherEnd, msgs);
			case SimplepdlPackage.WORK_DEFINITION__LINKS_TO_SUCCESSORS:
				return ((InternalEList)getLinksToSuccessors()).basicAdd(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			case SimplepdlPackage.WORK_DEFINITION__LINKS_TO_PREDECESSORS:
				...
				getLinksToPredecessors().addAll((Collection)newValue);
				return;
			case SimplepdlPackage.WORK_DEFINITION__LINKS_TO_SUCCESSORS:
				getLinksToSuccessors().clear();
				getLinksToSuccessors().addAll((Collection)newValue);
				return;
			case SimplepdlPackage.WORK_DEFINITION__NAME:
			...
			case SimplepdlPackage.WORK_DEFINITION__ALLOCATE:
				getAllocate().clear();
				getAllocate().addAll((Collection)newValue);
				return;
		}
