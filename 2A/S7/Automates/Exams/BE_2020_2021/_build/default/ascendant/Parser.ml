...
let rec _menhir_goto_liste_regions : _menhir_env -> 'ttv_tail -> _menhir_state -> (unit) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState14 ->
        ...
        let _v : (unit) = 
# 63 "ascendant/Parser.mly"
                                   ( (print_endline "liste_regions : region liste_regions") )
# 73 "ascendant/Parser.ml"
         in
        _menhir_goto_liste_regions _menhir_env _menhir_stack _menhir_s _v
    | MenhirState13 ->
        let _menhir_stack = Obj.magic _menhir_stack in
...
and _menhir_goto_region_bis : _menhir_env -> 'ttv_tail -> (unit) -> 'ttv_return =
...
# 117 "ascendant/Parser.ml"
    ...
    | UL_ACCFER ->
        _menhir_reduce4 _menhir_env (Obj.magic _menhir_stack) MenhirState21
    | _ ->
        assert (not _menhir_env._menhir_error);
        _menhir_env._menhir_error <- true;
...
# 138 "ascendant/Parser.ml"
     in
    _menhir_goto_liste_regions _menhir_env _menhir_stack _menhir_s _v

and _menhir_goto_ends_bis : _menhir_env -> 'ttv_tail -> (unit) -> 'ttv_return =
  fun _menhir_env _menhir_stack _v ->
...
and _menhir_goto_liste_etats : _menhir_env -> 'ttv_tail -> _menhir_state -> (unit) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState6 ->
...
# 46 "ascendant/Parser.mly"
                                                            ( (print_endline "region : UL_REGION UL_IDENT UL_ACCOUV liste_etats UL_ACCFER") )
# 206 "ascendant/Parser.ml"
             in
            let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
            (match _menhir_s with
...
# 230 "ascendant/Parser.ml"
                 in
                _menhir_goto_suite_machine_bis _menhir_env _menhir_stack _menhir_s _v
            | _ ->
                _menhir_fail ())
        | _ ->
            assert (not _menhir_env._menhir_error);
...
# 49 "ascendant/Parser.mly"
                               ( (print_endline "liste_etats : etat liste_etats") )
# 248 "ascendant/Parser.ml"
         in
        _menhir_goto_liste_etats _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        _menhir_fail ()

and _menhir_goto_starts_bis : _menhir_env -> 'ttv_tail -> (unit) -> 'ttv_return =
  fun _menhir_env _menhir_stack _v ->
    let _menhir_stack = (_menhir_stack, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
...
# 269 "ascendant/Parser.ml"
         in
        _menhir_goto_ends_bis _menhir_env _menhir_stack _v
    | UL_ACCFER | UL_ACCOUV | UL_STATE ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _v : (unit) = 
# 56 "ascendant/Parser.mly"
           ( (print_endline "ends_bis : mot vide") )
# 277 "ascendant/Parser.ml"
         in
        _menhir_goto_ends_bis _menhir_env _menhir_stack _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
and _menhir_goto_nom_qualifie : _menhir_env -> 'ttv_tail -> _menhir_state -> (unit) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState25 ->
...
# 18 "ascendant/Parser.mly"
       (string)
# 297 "ascendant/Parser.ml"
        ))), _, (_3 : (unit))) = _menhir_stack in
        let _2 = () in
        let _v : (unit) = 
# 44 "ascendant/Parser.mly"
                                           ( (print_endline "nom_qualifie : UL_IDENT . nom_qualifie") )
# 303 "ascendant/Parser.ml"
         in
        _menhir_goto_nom_qualifie _menhir_env _menhir_stack _menhir_s _v
    | MenhirState23 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
...
# 41 "ascendant/Parser.mly"
                                                                    ( (print_endline "transition : UL_FROM nom_qualifie UL_TO nom_qualifie UL_ON UL_IDENT") )
# 354 "ascendant/Parser.ml"
                 in
                let _menhir_stack = Obj.magic _menhir_stack in
                let _menhir_stack = Obj.magic _menhir_stack in
                let (_1 : (unit)) = _v in
...
and _menhir_goto_machine_bis : _menhir_env -> 'ttv_tail -> _menhir_state -> (unit) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    match _menhir_s with
    | MenhirState35 ->
...
# 35 "ascendant/Parser.mly"
                                            ( (print_endline "machine_bis : suite_machine_bis") )
# 391 "ascendant/Parser.ml"
         in
        _menhir_goto_machine_bis _menhir_env _menhir_stack _menhir_s _v
    | MenhirState3 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
...
# 48 "ascendant/Parser.mly"
              ( (print_endline "liste_etats : mot vide") )
# 445 "ascendant/Parser.ml"
     in
    _menhir_goto_liste_etats _menhir_env _menhir_stack _menhir_s _v
...
# 18 "ascendant/Parser.mly"
       (string)
# 519 "ascendant/Parser.ml"
        ))) = _menhir_stack in
        let _v : (unit) = 
# 43 "ascendant/Parser.mly"
                        ( (print_endline "nom_qualifie : UL_IDENT") )
# 524 "ascendant/Parser.ml"
         in
        _menhir_goto_nom_qualifie _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
and _menhir_goto_suite_machine_bis : _menhir_env -> 'ttv_tail -> _menhir_state -> (unit) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_stack = Obj.magic _menhir_stack in
    assert (not _menhir_env._menhir_error);
    ...
    | UL_ACCFER ->
        _menhir_reduce9 _menhir_env (Obj.magic _menhir_stack) MenhirState35
    | _ ->
        assert (not _menhir_env._menhir_error);
        _menhir_env._menhir_error <- true;
...
# 34 "ascendant/Parser.mly"
              ( (print_endline "machine_bis : mot vide") )
# 597 "ascendant/Parser.ml"
     in
    _menhir_goto_machine_bis _menhir_env _menhir_stack _menhir_s _v
...
# 18 "ascendant/Parser.mly"
       (string)
# 665 "ascendant/Parser.ml"
        )) = _v in
        let (_menhir_stack, _menhir_s) = _menhir_stack in
        let _1 = () in
        let _v : (unit) = 
# 37 "ascendant/Parser.mly"
                                       ( (print_endline "machine_bis : UL_EVENT UL_IDENT") )
# 672 "ascendant/Parser.ml"
         in
        _menhir_goto_suite_machine_bis _menhir_env _menhir_stack _menhir_s _v
    | _ ->
        assert (not _menhir_env._menhir_error);
...
# 65 "ascendant/Parser.mly"
  

# 754 "ascendant/Parser.ml"

# 269 "<standard.mly>"
  

# 759 "ascendant/Parser.ml"
