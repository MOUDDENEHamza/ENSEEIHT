...
public class PhiloTestGauche implements StrategiePhilo {

    /** Attributs de classe */
    private static Semaphore[] fourchettes;

    /** Constructeur de classe */
    public PhiloTestGauche (int nbPhilosophes) {
    ...
    public String nom() {
        return "Implantation Sémaphores, stratégie test la fourchette gauche";
    }
